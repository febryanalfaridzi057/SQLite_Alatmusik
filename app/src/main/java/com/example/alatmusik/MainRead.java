...
public class MainRead extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    private List<AlatMusik> ListToko = new ArrayList<AlatMusik>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListToko.clear();
        List<AlatMusik> contacts = db.ReadToko();
        for (AlatMusik cn : contacts) {
            AlatMusik judulModel = new AlatMusik();
            judulModel.set_id(cn.get_id());
            judulModel.set_nama(cn.get_nama());
            judulModel.set_kondisi(cn.get_kondisi());
    ...
    public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
        ...
        AlatMusik obj_itemDetails = (AlatMusik) o;
        String Sid = obj_itemDetails.get_id();
        String Snama = obj_itemDetails.get_nama();
        String Skondisi = obj_itemDetails.get_kondisi();
        String Sharga = obj_itemDetails.get_harga();

        Intent goUpdel = new Intent(MainRead.this, MainUpdel.class);
        goUpdel.putExtra("Iid", Sid);
        goUpdel.putExtra("Inama", Snama);
        goUpdel.putExtra("Ikondisi", Skondisi);
